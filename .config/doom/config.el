...
(setq org-capture-templates
      '(("t" "Todo" entry (file+headline "~/org/refile.org" "Tasks")
        ...
        ("n" "Notes" entry (file "~/org/notes.org")
         "* %?\n %u")
        ("c" "Commands" entry (file "~/org/commands.org")
         "* %?\n #+begin_src shell \n #+end_src \n %u")))
...
;; Open eww in a full buffer instead of the popup window
(after! eww
...
;;
;; Disables evil-snipe-mode so the S vim keybind is used properly
(after! evil-snipe
  (evil-snipe-mode -1))

;; Keybind to create a file in dired
(map! :map dired-mode-map
      :n "_" #'dired-create-empty-file)
;;
